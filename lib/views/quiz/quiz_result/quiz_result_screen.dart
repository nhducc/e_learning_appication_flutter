...
import 'package:e_learning_application_clone/views/quiz/quiz_result/widgets/quiz_question_analysis.dart';
import 'package:e_learning_application_clone/views/quiz/quiz_result/widgets/quiz_score_card.dart';
import 'package:e_learning_application_clone/views/quiz/quiz_result/widgets/quiz_stats_card.dart';
          ...
          SliverAppBar(
            ...
            leading: IconButton(
              onPressed: () => Get.offAllNamed(
                AppRoutes.main,
                arguments: {'initialIndex': 2}, //2 is the index for quiz tab
              ),
